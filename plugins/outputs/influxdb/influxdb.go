...
import (
	...
	"github.com/defineiot/dpipe/plugins/outputs/influxdb/client"
)
...
func (i *InfluxDB) Write(metrics []metrics.Metric) error {
	r := influx.NewReader(metrics)
...
func init() {
	outputs.Add("influxdb", func() outputs.Output { return newInflux() })
}
