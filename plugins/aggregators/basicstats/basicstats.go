...
import (
	...
	"github.com/defineiot/dpipe/plugins/aggregators"
)
...
func (m *BasicStats) Add(in metrics.Metric) {
	id := in.HashID()
...
func (m *BasicStats) Push(acc data.Accumulator) {
...
func init() {
	aggregators.Add("basicstats", func() aggregators.Aggregator {
